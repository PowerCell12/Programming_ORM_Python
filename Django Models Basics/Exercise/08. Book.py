...
class UserProfile(models.Model): ## the 6 task
...
class Exercise(models.Model): ## the 7 task
...
class Book(models.Model):
    ...
    genre = models.CharField(max_length=20, choices=types)
    publication_date = models.DateField(editable=False, auto_now=True)## maybe error
