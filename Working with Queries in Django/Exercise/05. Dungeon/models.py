...
class Laptop(models.Model):
    brand = models.CharField(choices=TYPES, max_length=100)   ## if error remove the max_length
    ...
    operation_system = models.CharField(choices=OP_TYPES, max_length=100) ## if error remove the max_length
    price = models.DecimalField(max_digits=10, decimal_places=2)
